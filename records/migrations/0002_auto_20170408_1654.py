...
def fill_data(apps, schema_editor):
    ...
    Document.objects.create(title='e1', data='eve record 1 data data data data data data', owner=3)
    Document.objects.create(title='e2', data='eve record 2 data data data data data data', owner=3)
